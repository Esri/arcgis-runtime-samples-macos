...
class LineOfSightGeoElementViewController: NSViewController {
    ...
    @IBOutlet var targetVisibilityLabel: NSTextField!
    @IBOutlet var observerZLabel: NSTextField!
    @IBOutlet var observerZSlider: NSSlider!
    ...
    @IBAction func observerHeightChanged(_ observerZSlider: NSSlider) {
        if let oldLocation = observerGraphic.geometry as? AGSPoint,
            let newLocation = AGSGeometryEngine.geometry(bySettingZ: observerZSlider.doubleValue, in: oldLocation) as? AGSPoint {
    ...
    override func viewWillAppear() {
        ...
        // update the ui
        observerZSlider.doubleValue = observerPoint.z
        updateObserverZLabel()
    }
    ...
    private func updateLineOfSightVisibilityLabel(visibility: AGSLineOfSightTargetVisibility) {
        ...
        case .visible:
            targetVisibilityLabel.stringValue = "Visible"
            taxiGraphic.isSelected = true
        case .unknown:
            targetVisibilityLabel.stringValue = "Unknown"
            taxiGraphic.isSelected = false
        }
    }
